...
<form name="pp1" action="g03.php"  method="POST" >
...
<tr><td><p><b>COLLAGE NAME(2schoice)</b></p></td>
            <td><select name="gs2"><option> <?php echo $row['f3collage']; ?>
           </option></select> </td></tr>
            <tr><td><p><b>stream1</b></p></td>
            <td><input type="text" name="gs3" value="<?php echo $row['f3s1']; ?>">
            </td></tr>
            <tr><td><p><b>stream2</b></p></td>
            <td><input type="text" name="gs4" value="<?php echo $row['f3s2']; ?>">
