...
<td><input type="text" name="f01" id="j12" onfocus="setstyle(this.id)" onblur="setstyle1(this.id)" value="<?php echo $row['roll']; ?>" placeholder="Roll no required" required>
</td>
<td class="reg1"><p>Rank:</p>
</td>
<td><input type="number" name="f02" id="j13" onfocus="setstyle(this.id)" onblur="setstyle1(this.id)" value="<?php echo $row['rank']; ?>">
<?php
}?></td>
</tr><tr><td></td><td></td><td></td></tr>
<tr><td class="reg1"><p>H.S%:</p></td><td><input type="number" name="f03" id="j14" onfocus="setstyle(this.id)" onblur="setstyle1(this.id)" value=""></td>
...
<td></td>
<td></td>
<td width="300px" class="serach"><input type="text" name="se1" id="j15" onfocus="setstyle(this.id)" onblur="setstyle1(this.id)" value=""></td>
<tr>
<td></td>
<td></td>
<td></td>
...
<tr><td class="reg1"><p>Collage name:</p></td>
<td>
<select name="f08" id="secend" onfocus="setstyle(this.id)" onblur="setstyle1(this.id)">
<option value="">COLLEGE OF ENGINEERING&MANAGEMENT,KOLAGHAT</option>
<option>
...
<td><input type="password" id="j16" onfocus="setstyle(this.id)" onblur="setstyle1(this.id)" name="f14" value="<?php echo$password;?>"></td></tr>
