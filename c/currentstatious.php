...
echo"Welcome Admin!!!";
?></CENTER>
      <center><h1 size="50px" font-style="bold" color="red">AVAILABLE SEAT STATUS</h1></center>
</head>
<body bgcolor="#99CC33">
  <style>
  html,body{
    background:url(https://images.unsplash.com/photo-1484503793037-5c9644d6a80a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2002&q=80);
  }
</style>
