...
<style>
  html,body{
    background:url(https://images.unsplash.com/photo-1567697025088-76ceb32963fa?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=967&q=80);
...
<td><input type="text" name="f1" id="j1" onfocus="setstyle(this.id)" onblur="setstyle1(this.id)" value="" placeholder="Student name" required>
</td>
</tr>
<tr>
<td class="reg1">
...
<td><input type="text" name="f2" id="j2" onfocus="setstyle(this.id)" onblur="setstyle1(this.id)" value="" placeholder="Gurdaint name" required><td class="wo"><?php echo"* field are compulseary"?></td>
</td>
</tr>
<tr>
<td class="reg1"><p>Adress:<span style="color :red;">*</span></p></td>
<td><textarea width="50px" height="50px" name="f3" id="j3" onfocus="setstyle(this.id)" onblur="setstyle1(this.id)" value="" placeholder="parmanent Address" required>
</textarea>
</td>
</tr>
<tr>
...
<td>
<p><input type="text" id="datepicker" name="f4" onfocus="setstyle(this.id)" onblur="setstyle1(this.id)"></p>
</td>
</tr>
<tr>
...
<td><input type="text" id="emailid"  onfocus="setstyle(this.id)" onblur="setstyle1(this.id)" name="f7" value="" placeholder=" email id" required></td></tr>
<tr><td class="reg1"><p>ContactNo:<span style="color :red;">*</span></p></td>
<td><input type="number" name="cno1" id="cno1" onfocus="setstyle(this.id)" onblur="setstyle1(this.id)" value="" placeholder=" contact no" requireds></td></tr>
